...
const NAV_GROUPS = [
  {
    ...
    basePaths: ["/crm", "/pipeline", "/compras", "/kickoff", "/kickoffs", "/contratos", "/cadastros", "/orders", "/pedidos"],
  ...
  },
  {
    ...
    roles: ["admin", "sales_ops", "compras", "faturamento", "gestor"],
    children: [
  ...
  },
  {
    ...
    roles: ["admin", "lider_pd", "formulador", "qa", "engenharia_produto", "compras", "logistica", "estoque", "faturamento", "sales_ops", "gestor"],
    children: [
      ...
      { label: "Devolucoes / Retrabalho", path: "/logistica/devolucoes", icon: RotateCcw },
  ...
  },
  {
    ...
    icon: Factory,
    basePaths: ["/pcp"],
    roles: ["admin", "lider_pd", "formulador", "qa", "engenharia_produto", "compras", "pcp", "producao", "gestor", "sales_ops"],
    children: [
      { label: "Planejamento", path: "/pcp/planejamento", icon: Calendar, exact: true },
      { label: "Controle de OPs", path: "/pcp/controle-ops", icon: Factory },
      { label: "Emitir OP", path: "/pcp/emitir-op", icon: FileText },
      { label: "Pedidos", path: "/pcp/pedidos", icon: ClipboardList },
      { label: "Matriz de Insumos (MRP)", path: "/pcp/matriz-insumos", icon: Package },
      { label: "Ajustes / Config", path: "/pcp/ajustes", icon: Layers3 },
      { label: "Historico de Apontamentos", path: "/pcp/historico", icon: BarChart3 },
    ],
  },
];
